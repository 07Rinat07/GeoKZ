...
После ввода GeoKZ преобразует рабочую точку в WGS84 и выполняет поиск в выбранном радиусе. Результат содержит административный контекст, ближайшие месторождения/геологические объекты, пробурённые скважины с расстоянием и интервалами, а также сейсмические исследования. По найденной скважине можно открыть полный паспорт, а несколько соседних скважин затем использовать для корреляции разрезов.
...
Выберите опорную скважину и соседние скважины. GeoKZ формирует сопоставление разрезов визуально и текстом: реперы, литология, коллекторы, нефть/газ/вода, глубины, мощности, net pay, пористость и проницаемость.
